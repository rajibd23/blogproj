...
from django.shortcuts import render, redirect, get_object_or_404, reverse, NoReverseMatch
...
def knowledge_index(request,
    ...
    #paginator, questions = paginate(questions, 10, page)
    try:
...
def knowledge_list(request,
    ...
    if search:
        ...
        print("Inside knowledge list search")
    category = None
    if category_slug:
        category = get_object_or_404(Category, slug=category_slug)
        questions = questions.filter(categories=category)
        print("Inside knowledge list category")
